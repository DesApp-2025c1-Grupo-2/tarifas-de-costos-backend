...
public class ReporteController {
    ...
    public ResponseEntity<List<TransportistaTarifasDTO>> getTransportistasMasUtilizados() {
        ...
        // Si la lista está vacía, podrías devolver 204 No Content o un OK con lista vacía.
    ...
    public ResponseEntity<ReporteVehiculoCombustibleDTO> getReporteUsoCombustible(
        ...
        try {
             ...
             // Considerar si realmente quieres devolver 204 si ambos son 0, o si un reporte con 0s es válido.
             ...
             // Devolver 404 si el error fue porque no se encontró el vehículo podría ser una opción,
    ...
    public ResponseEntity<ComparativaTransportistaDTO> getComparativaCostos(
        ...
        ComparativaTransportistaDTO reporte = reporteService.generarComparativaPorServicio(zonaId, tipoVehiculoId, tipoCargaId);

        if (reporte.getComparativas() == null || reporte.getComparativas().isEmpty()) {
             // Devolver 204 No Content es apropiado aquí si no se encuentran tarifas que coincidan
            return ResponseEntity.noContent().build();
        }
